...
public class VormerkWerkzeug
{
            ...
            KundenstammService kundenstamm, VerleihService verleihService)
    {
        ...
        Assert.assertTrue(verleihService instanceof VormerkService);
        _vormerkService = (VormerkService) verleihService;
        
        //TODO instanceof Test machen!
    ...
    private boolean istVormerkenMoeglich()
    {
        ...
        {
            return _vormerkService.medienVonKundeVormerkbar(kunde, medien);
        }
       
        
        //TODO Evtl schöner machen

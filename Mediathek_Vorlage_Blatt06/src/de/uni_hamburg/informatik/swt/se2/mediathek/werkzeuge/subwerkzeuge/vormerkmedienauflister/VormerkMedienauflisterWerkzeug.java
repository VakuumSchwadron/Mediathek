...
public class VormerkMedienauflisterWerkzeug extends ObservableSubWerkzeug
{
            ...
            VerleihService verleihService)
    {
        ...
        _vormerkService = (VormerkService) verleihService;
    ...
    private void setzeAnzuzeigendeMedien()
    {
        ...
        for (Medium medium : medienListe)
        {
            ...
            if(_vormerkService.mediumHatVormerker(medium))
            {
                vormerker1 = _vormerkService.getVormerker(medium)[0];
                vormerker2 = _vormerkService.getVormerker(medium)[1];
                vormerker3 = _vormerkService.getVormerker(medium)[2];
            }

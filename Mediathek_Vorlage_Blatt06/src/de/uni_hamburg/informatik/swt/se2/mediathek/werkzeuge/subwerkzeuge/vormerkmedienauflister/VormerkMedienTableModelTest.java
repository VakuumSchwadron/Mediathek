...
public class VormerkMedienTableModelTest
{
    ...
    public VormerkMedienTableModelTest()
    {
        ...
        medien.add(new VormerkMedienFormatierer(_cd1, _kunde1, _kunde2,
                _kunde3, _kunde4));
        medien.add(new VormerkMedienFormatierer(_cd2, _kunde2, _kunde3,
                _kunde4, _kunde1));
        medien.add(new VormerkMedienFormatierer(_cd3, _kunde3, _kunde4,
                _kunde1, _kunde2));
